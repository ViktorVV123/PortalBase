...
export const WidgetColumnsOfTable = ({updateWidgetColumn,widgetColumns,selectedWidget,loadColumnsWidget,addReference,deleteColumnWidget}:WidgetColumnsProps) => {
